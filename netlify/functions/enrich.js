...
exports.handler = async function (event) {
  ...
  if (!products || !Array.isArray(products) || products.length === 0) {
    return { statusCode: 400, headers: CORS, body: JSON.stringify({ error: "No se enviaron productos" }) };
  }
  ...
  return { statusCode: 500, headers: CORS, body: JSON.stringify({ error: "Error de IA: " + lastError }) };
};
